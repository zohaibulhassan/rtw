...
echo admin_form_open_multipart("productions/edit_payment_submit/" . $payment->id, $attrib); ?>
    ...
    <div class="uk-grid">
        <div class="uk-width-large-1-2">
            <div class="md-input-wrapper md-input-filled">
                ...
                <input type="hidden" value="<?php echo $payment->production_id; ?>" name="production_id"/>
