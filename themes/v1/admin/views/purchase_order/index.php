...
<div id="page_content">
    ...
    <div class="md-card">
            ...
            <div class="md-card-content" >
                <form action="<?php echo base_url('admin/purchaseorder'); ?>" method="get">
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="uk-width-large-1-4">
                            <div class="md-input-wrapper md-input-filled">
                                ...
                                <select name="status" class="uk-width-1-1 select2"  >
                                    ...
                                    <option value="closed" <?php if($status == "closed"){ echo 'selected'; } ?> >Close</option>
                                </select>
                            </div>
                        </div>
                        <div class="uk-width-large-1-4" style="padding-top: 20px;">
                            ...
                            <a href="<?php echo base_url('admin/purchaseorder'); ?>" class="md-btn md-btn-danger md-btn-wave-light waves-effect waves-button waves-light" >Reset</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Purchase Orders</h3>
                <div class="md-card-toolbar-actions">
...
<div class="md-fab-wrapper md-fab-in-card" style="position: fixed;bottom: 20px;">
    <a class="md-fab md-fab-success md-fab-wave waves-effect waves-button addbtn" href="<?php echo base_url('admin/purchaseorder/add') ?>"><i class="fa-solid fa-plus"></i></a>
</div>
<!-- datatables -->
...
<script>
    ...
    $.DataTableInit({
        ...
        url:"<?= admin_url('purchaseorder/get_lists'); ?>",
        data:data,
        aaSorting: [[0, "desc"]],
        columnDefs: [
            { 
