    ...
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Edit Receiving Items</h3>
                            ...
                            foreach($items as $item){
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input class="md-input md-input-success label-fixed" name="batch[]" type="text" autocomplete="off"" value="<?= $item->batch_code ?>">
                                        </td>
                                        <td>
                                            <input class="md-input md-input-success label-fixed" name="rqty[]" type="number" autocomplete="off" tabindex="2" data-id="" data-item="" id="" min="0" value="<?= $item->received_qty ?>">
                                        </td>
                                        <td>
                                            <input class="md-input  label-fixed" type="text" name="expirydate[]" data-uk-datepicker="{format:'YYYY-MM-DD'}" autocomplete="off" readonly value="<?= date("Y-m-d", strtotime($item->expiry_date))  ?>">
...
<script>
    $(document).ready(function(){
        ...
        $('#editrecived_form').submit(function(e){
            ...
            $.ajax({
                url: '<?php echo base_url('admin/purchaseorder/submit_editrecived'); ?>',
                type: 'POST',
