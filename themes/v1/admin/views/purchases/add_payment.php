...
echo admin_form_open_multipart("purchases/add_payment_submit/" . $inv->id, $attrib); ?>
    ...
    <div class="uk-grid">
        ...
        <div class="uk-width-large-1-2">
            <div class="md-input-wrapper md-input-filled">
                ...
                <input type="number" name="amount-paid" class="md-input md-input-success label-fixed" required autocomplete="off" value="<?= $this->sma->formatDecimal($inv->grand_total - $inv->paid) ?>" >
            </div>
        </div>
        <div class="uk-width-large-1-2">
            <div class="md-input-wrapper md-input-filled">
