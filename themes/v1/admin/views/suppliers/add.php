            ...
            <div class="md-card-content" >
                ...
                ?>
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-large-1-2">
                            <div class="md-input-wrapper md-input-filled">
                                <label>NTN <span class="red" >*</span></label>
                                <input type="text" name="ntn" class="md-input md-input-success label-fixed" required>
                            </div>
                        </div>
                        <div class="uk-width-large-1-2">
                            <div class="md-input-wrapper md-input-filled">
                                <label>GST <span class="red" >*</span></label>
                                <input type="text" name="gst" class="md-input md-input-success label-fixed" required>
                            </div>
                        </div>
                        <div class="uk-width-large-1-2">
                            <div class="md-input-wrapper md-input-filled">
                                <label>Linces <span class="red" >*</span></label>
                                <input type="text" name="linces" class="md-input md-input-success label-fixed" required>
                            </div>
                        </div>
                    </div>
