...
$(document).ready(function (e) {
  ...
  $(document).on("click", ".edit", function () {
    ...
    if (item.options !== false) {
      var o = 1;
      opt = $(
        '<select id="poption" name="poption" class="md-input md-input-success label-fixed select" />'
      );
      $.each(item.options, function () {
        if (o == 1) {
          if (product_option == "") {
    ...
    if (item.units) {
      uopt = $(
        '<select id="punit" name="punit" class="md-input md-input-success label-fixed select" />'
      );
  ...
  $(document).on("click", ".load_amount", function () {
    ...
    // if (item.options !== false) {
    //     var o = 1;
    //     opt = $("<select id=\"poption\" name=\"poption\" class=\"md-input md-input-success label-fixed select\" />");
    //     $.each(item.options, function () {
    //         if (o == 1) {
    ...
    // uopt = '<p style="margin: 12px 0 0 0;">n/a</p>';
    // if (item.units) {
    //     uopt = $("<select id=\"punit\" name=\"punit\" class=\"md-input md-input-success label-fixed select\" />");
    //     $.each(item.units, function () {
    //         if (this.id == item.row.unit) {
  ...
  $(document)
    ...
    .on("change", ".rquantity", function () {
      ...
      let get_selected_product_quantities = $(
...
function loadItems() {
  if (localStorage.getItem("slitems")) {
    ...
    $.each(sortedItems, function () {
      ...
      var remaning_qty = 0
      if (typeof item.row.get_selected_product_quantities !== 'undefined') {
        remaning_qty = item.row.get_selected_product_quantities
      }
      ...
      if (site.settings.product_serial == 1) {
        tr_html +=
          '<td class="text-right"><input class="md-input md-input-success label-fixed input-sm rserial" name="serial[]" type="text" autocomplete="off" id="serial_' +
          row_no +
          '" value="' +
          item_serial +
          '"></td>';
      ...
      if (item.row.tax_method == "0") {
        ...
        tr_html +=
          '<td class="text-right"><input class="md-input md-input-success label-fixed input-sm text-right rprice" name="net_price[]" type="hidden" id="price_' +
          row_no +
          '" value="' +
          inclusive_price_calculation +
          '"><input id="ruprice_' +
      ...
      tr_html +=
        ...
        "</span> </td>";
      tr_html +=
        '<td><input class="md-input md-input-success label-fixed text-center rquantity" tabindex="' +
        ...
        tr_html +=
          '<td><input class="md-input md-input-success label-fixed text-center batch_remain_quantity" name="batch_remain_quantity[]" type="text" autocomplete="off" value="' +
          remaning_qty +
          '" data-id="' +
          row_no +
          '" data-item="' +
        ...
        tr_html +=
          ...
          row_no +
          '" name="batch_number[]" class="batch_number md-input md-input-success label-fixed" data-item-id="' +
          row_no +
          '">';
        ...
        tr_html +=
          ...
          '"></td>';
      tr_html += '<td>';
      tr_html += '<input type="hidden" value="0" id="discount_one_' +
        row_no +
        '"  class="discount_one" name="discount_one_' +
        my_count + '" >';
      tr_html += '<input type="hidden" value="0" id="discount_two_' +
        row_no +
        '"  class="discount_two" name="discount_two_' +
        my_count + '" >';
      tr_html += '<input type="hidden" value="0" id="discount_three_' +
        row_no +
        '"  class="discount_three" name="discount_three_' +
        my_count + '" >';
      tr_html +=
        '<select id="check_discount_list_' +
        row_no +
        '" name="check_discount_list[]" class="check_discount_list md-input md-input-success label-fixed" data-item-id="' +
        row_no +
        '">';
      tr_html += '<option value="">Select</option>';
      for (
      ...
      tr_html +=
        ...
        row_no +
        '"  class="md-input md-input-success label-fixed input-sm text-right fed_tax" name="fed_tax_' +
        my_count +
      ...
      if (
        ...
        tr_html +=
          '<td class="text-right"><input class="md-input md-input-success label-fixed input-sm rdiscount" name="product_discount[]" type="hidden" id="discount_' +
          row_no +
          '" value="' +
          item_ds +
      ...
      if (customer_type == "consignment" || customer_type == "cost") {
        if (site.settings.tax1 == 1) {
          ...
          tr_html +=
            '<td class="text-right"><input class="md-input md-input-success label-fixed input-sm text-right rproduct_tax" name="product_tax[]" type="hidden" id="product_tax_' +
            row_no +
            '" value="' +
            pr_tax.id +
            '"> <input class="md-input md-input-success label-fixed input-sm text-right rproduct_tax" name="product_tax_' +
            my_count +
        ...
        if (item.gst_no == "") {
          if (customer_type == "consignment" || customer_type == "cost") {
            if (item.tax_rate.type == 1) {
              ...
              tr_html +=
                '<td class="text-right"><input class="md-input md-input-success label-fixed input-sm text-right rproduct_tax" name="further_tax_' +
                my_count +
    ...
    var tfoot =
      ...
      '</th><th class="text-center"></th><th class="text-center"></th><th class="text-center"></th><th class="text-center"></th>';
    if (
      (site.settings.product_discount == 1 && allow_discount == 1) ||
      product_discount
    ) {
...
$(document).on("change", ".check_discount_list", function () {
  ...
  // tr_html += '<td><select id="check_discount_list_' + row_no + '" name="check_discount_list[]" class="check_discount_list md-input md-input-success label-fixed" data-item-id="' + row_no + '">';
  // tr_html += '<option value="">Select</option>';
...
$(document).on("change", ".batch_number", function () {
  ...
  console.log("QB: "+get_selected_product_quantities);
