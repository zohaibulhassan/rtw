    ...
    if (localStorage.getItem('slitems')) {
        ...
        $.each(sortedItems, function() {
            ...
            if (item.row.tax_method == '0') {
                // If inclusive
                price_value_condition = ((customer_type == "consignment") ? (item.row.get_selected_product_price) : (customer_type == "dropship") ? (item.row.get_selected_product_dropship) : (customer_type == "crossdock") ? (item.row.get_selected_product_crossdock) : (customer_type == "services") ? "services" : "0");



                inclusive_price_calculation = price_value_condition / ((item.tax_rate.rate / 100) + 1);


                tr_html += '<td class="text-right"><input class="form-control input-sm text-right rprice" name="net_price[]" type="hidden" id="price_' + row_no + '" value="' + inclusive_price_calculation + '"><input id="ruprice_' + row_no + '" class="ruprice" name="unit_price[]" type="hidden" value="' + inclusive_price_calculation + '"><input id="realuprice_' + row_no + '" class="realuprice" name="real_unit_price[]" type="hidden" value="' + inclusive_price_calculation + '"><span class="text-right sprice" id="sprice_' + row_no + '">' + formatMoney(inclusive_price_calculation) + '</span> </td>';
            }
            ...
            if (item.row.tax_method == '1') {
                ...
                tr_html += '<td class="text-right"><input class="form-control input-sm text-right rprice" name="net_price[]" type="hidden" id="price_' + row_no + '" value="' + price_value_condition + '"><input id="ruprice_' + row_no + '" class="ruprice" name="unit_price[]" type="hidden" value="' + price_value_condition + '"><input id="realuprice_' + row_no + '" class="realuprice" name="real_unit_price[]" type="hidden" value="' + price_value_condition + '"><span class="text-right sprice" id="sprice_' + row_no + '">' + formatMoney(price_value_condition) + '</span> </td>';
            }
                ...
                if (item.gst_no == "") {
                    if (customer_type == "consignment") {
                        if (item.tax_rate.type == 1) {
                            ...
                            $furhter_tax_value_total += $furhter_tax_value;
                            tr_html += '<td class="text-right 5"><input class="form-control input-sm text-right rproduct_tax" name="further_tax[]" type="hidden" id="further_tax_' + row_no + '" value="' + $furhter_tax_value + '"><span class="text-right sproduct_tax" id="sproduct_tax_' + row_no + '">' + '(' + formatDecimal(item.row.further_tax) + ')' + '<br> ' + formatMoney($furhter_tax_value) + '</span></td>';
                        } else {
                            tr_html += '<td class="text-right 6"><span class="text-right sproduct_tax" > 0 </span></td>';
                        }
                    } else {
                        tr_html += '<td class="text-right 7"><span class="text-right sproduct_tax" > 0 </span></td>';
                    }
                } else {
                    tr_html += '<td class="text-right 8"><span class="text-right sproduct_tax" > 0 </span></td>';
                }
            }
            ...
            tr_html += '<td class="text-right"><span class="text-right ssubtotal" id="subtotal_' + row_no + '">' +

                formatMoney(((parseFloat(item_price) + ((customer_type == "consignment") ? parseFloat(pr_tax_val) : 0)) * parseFloat(item_qty) - item_ds) + (((item.gst_no == "") && (customer_type == "consignment") && (item.tax_rate.type == 1)) ? parseFloat($furhter_tax_value) : ((inclusive_price_calculation + ((customer_type == "consignment") ? parseFloat(pr_tax_val) : 0)) * parseFloat(item_qty)))) + '</span></td>';
            ...
            total += formatDecimal(((parseFloat(item_price) + ((customer_type == "consignment") ? parseFloat(pr_tax_val) : 0)) * parseFloat(item_qty) - item_ds) + (((item.gst_no == "") && (customer_type == "consignment") && (item.tax_rate.type == 1)) ? parseFloat($furhter_tax_value) : ((inclusive_price_calculation + ((customer_type == "consignment") ? parseFloat(pr_tax_val) : 0)) * parseFloat(item_qty))), 4);
