...
<?php if(($user_details[0]->biller_id) && $chatData) {
...
<?php if($user_details[0]->warehouse_id !== "2"){ ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul id="dbTab" class="nav nav-tabs">
                                ...
                                <?php print_r($user_details[0]->warehouse_id) ; ?>

                                <?php if ((($user_details[0]->biller_id !== 0 ) || $GP['sales-index'] && ($user_details[0]->warehouse_id == 2) )) { ?>
                                <li class=""><a href="#sales"><?= lang('sales') ?></a></li>
                                <?php } if ((($user_details[0]->biller_id) || $GP['purchases-index']) && ($user_details[0]->warehouse_id == 2) ) { ?>
                            ...
                            <?php if (($user_details[0]->biller_id) || $GP['sales-index']) { ?>
                                ...
                                <?php } if (($user_details[0]->biller_id) || $GP['purchases-index']) { ?>
    ...
    <?php if ((($Owner || $Admin) && $chatData) || ($user_details && $chatData) ) { ?>
