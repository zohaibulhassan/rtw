...
<script>
    $(document).ready(function () {
        oTable = $('#SLData').dataTable({
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": null}, null, null, null, {"mRender": row_status}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": pay_status}, {"bSortable": false,"mRender": attachment}, {"bVisible": false}, {"bSortable": false}, {"bSortable": false}, {"bSortable": false}],
            ...
            {column_number: 3, filter_default_label: "[<?=lang('To');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('From');?>]", filter_type: "text", data: []},
