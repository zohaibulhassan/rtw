            ...
            <div class="col-lg-12">
                ...
                <div class="padding10">
                    ...
                    <div class="col-xs-4">
                        ...
                        <strong> <?= lang('P.O #'); ?>: </strong> <?php echo $inv->po_number; ?>
                    </div>
                ...
                <div class="col-xs-12" style="margin-top: 15px;">
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            <thead>
                                <tr>
                                    ...
                                    // echo '<th>Discount 3 <br> Per Piece</th>';
                                    ?>
                                    <th><?= lang('quantity'); ?></th>
                                    <!-- <th><?= lang('subtotal'); ?></th> -->
                                </tr>
                            ...
                            <tbody>
                                ...
                                foreach ($rows as $row) :
                                    ...
                                    // $five = $four - ($row->discount_three/100)*$unit_price_show;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center; width:90px;"><?= $row->sma_purchase_items_batch; ?></td>
                                        <td style="text-align:center; width:90px;"><?= $row->selected_expiry; ?></td>


                                        <td style="text-align:center; width:90px;"><?php echo round($row->unit_quantity, 0); ?></td>
                                        ...
                                        // echo '<td style="text-align:center; vertical-align:middle;">'.$this->sma->formatQuantity(($row->discount_three == "") ? "0" : $row->discount_three).'% <br> '.($row->discount_three/100)*$unit_price_show.'</td>';
                    ...
                    <tr>
                        <td style="font-weight: bold; width:60%; border:none"></td>
                        <td class="table-bordered" style="font-weight: bold; width:20%;">Total Discount Three</td>
                        <td class="table-bordered" style="width:20%; text-align:right;"><?php echo $this->sma->formatMoney($total_discount_three); ?></td>
                    </tr> 
