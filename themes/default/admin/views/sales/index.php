...
<script>
    $(document).ready(function () {
        oTable = $('#SLData').dataTable({
            ...
            // {column_number: 3, filter_default_label: "[<?=lang('so_id');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('PO_Number');?>]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[<?=lang('To');?>]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[<?=lang('From');?>]", filter_type: "text", data: []},
