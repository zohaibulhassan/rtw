        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="text-center" style="margin-bottom:20px;position: relative;">
                    <h1 style="font-size: 20px;font-weight: bolder;font-family: 'Arial' !important;">Bill</h1>
                </div>
                <?php 
                    }
                ?>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr class="warning">
                                ...
                                <?php
                                    if ($Settings->tax1 && $inv->product_tax > 0) {
                                        echo '<td style="text-align:center; vertical-align:middle;">' . ($row->item_tax != 0 ? '<small>('.($Settings->indian_gst ? $row->tax : $row->tax_code).')</small>' : '') . ' ' . $this->sma->formatMoney2(($row->item_tax/$row->quantity)*$row->unit_quantity) . '</td>';
                                    }
                                    if ($Settings->product_discount && $inv->product_discount != 0) {
