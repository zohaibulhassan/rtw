                    ...
                    <div class="col-lg-12">
                                    ...
                                    <?php if ($Owner || $Admin || !$this->session->userdata('own_companies_id')) { ?>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                echo form_dropdown('own_company', $oc, (isset($_POST['own_companies']) ? $_POST['own_companies'] : $inv->own_company), 'id="poown_companies" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("own_companies") . '" required="required" style="width:100%;",  ');
                                                ?>
                                            </div>
                                        </div>
                                    <?php } else {
                                ...
                                <?php if ($Owner || $Admin || !$this->session->userdata('suppliers_id')) { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('supplier', $oc, (isset($_POST['supplier']) ? $_POST['supplier'] : $inv->supplier_id), 'id="posupplier" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("supplier") . '" required="required" style="width:100%;" ');
                                            ?>
                                        </div>
                                    </div>
                                <?php } else {
                                ...
                                <div class="controls table-controls">
                                    <table id="slTable" class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-md-1"><?= lang("Remain quantity"); ?></th>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('po_number', $inv->po_number, 'class="form-control input-tip" id="po_number"'); ?>
                            </div>
                        </div>
                        <div class="clearfix"></div>
