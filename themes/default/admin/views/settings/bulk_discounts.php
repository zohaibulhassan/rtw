...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#STData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getDiscounts'.($warehouse_id ? '/'.$warehouse_id : '')) ?>',
            ...
            "aoColumns": [
                {"bSortable": false, "mRender": checkbox}, /* {"mRender": fld}*/ null, null, null,null,null, {"mRender": count_type}, null, null, null /*,  {"bSortable": false}*/
            ]
...
<div class="box">
    <div class="box-header">
        <h2 class="blue">
            ...
            <?= lang('Bulk Discount') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>

        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a href="<?= admin_url('system_settings/add_bulk_discount') ?>" class="tip" data-placement="top" title="<?= lang("Add_Bulk_Discount") ?>">
                ...
                <div class="table-responsive">
                    <table id="STData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr class="primary">
                            ...
                            <th class="col-xs-1"><?= lang("Discount Name") ?></th>
                            <th class="col-xs-1"><?= lang("Discount Code") ?></th>
                            <th class="col-xs-1"><?= lang("Percentage") ?></th>
                            <th class="col-xs-2"><?= lang("Supplier") ?></th>
                            <th class="col-xs-2"><?= lang("Brand") ?></th>
                            <th class="col-xs-2"><?= lang("Product") ?></th>
                            <th class="col-xs-1"><?= lang("Start Date") ?></th>
                            <th class="col-xs-1"><?= lang("End Date") ?></th>
                            <th class="col-xs-1" style="max-width:65px; text-align:center;"><?= lang("actions") ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
