        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php
                                    $am = array(0 => 'FIFO (First In First Out)', 1 => 'LIFO (Last In First Out)', 2 => 'AVCO (Average Cost Method)', 3 => 'Batch Wise');
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="gst_tax">GST Tax in percentage</label>
                            <?= form_input('gst_tax', $Settings->gst_tax, 'class="form-control tip" id="gst_tax" required="required"'); ?>
                        </div>
                    </div>

                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="further_tax">Further Tax in percentage</label>
                            <?= form_input('further_tax', $Settings->further_tax, 'class="form-control tip" id="further_tax" required="required"'); ?>
                        </div>
                    </div>
                    ...
                    <!-- <div class="col-md-4">
                        <div class="form-group">
                            <label for="fed_tax">FED TAX in percentage</label>
                            <?= form_input('fed_tax', $Settings->fed_tax, 'class="form-control tip" id="fed_tax" required="required"'); ?>
                        </div>
                    </div> -->
