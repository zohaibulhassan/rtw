                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <span style="display:inline-block;">
                                            ...
                                            <label for="reports-index" class="padding05"><?= lang('reports') ?></label>
                                        </span>
                                        ...
                                        <span style="display:inline-block;">
                                            <input type="checkbox" value="1" class="checkbox" id="suppliers" name="report_details" <?php echo $p->{'report_details'} ? "checked" : ''; ?>>
                                            <label for="suppliers" class="padding05"><?= lang('Detail Reports') ?></label>
                                        </span>
