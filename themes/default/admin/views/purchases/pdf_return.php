...
<body>
    <div id="wrap">
        <div class="row">
            <div class="col-lg-12">
                <?php
                    echo "<h2 class='text-center'> Purchase Return</h2>";
                ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td style="text-align:center; vertical-align:middle;"><?= $this->sma->formatQuantity($row->quantity) . ' pcs'; ?></td>
                                        ...
                                        <?php
                                        if ($Settings->product_discount && $inv->product_discount != 0) {
                                            echo '<td style="text-align:right; vertical-align:middle;">' . ($row->discount != 0 ? '(' . $this->sma->formatMoney($row->discount) . ')' : '0') .  '</td>';
                                        }
                                        ?>
                                        <td style="text-align:right; vertical-align:middle;"><?= $this->sma->formatMoney($row->adv_tax); ?></td>
                                        <td style="text-align:right; vertical-align:middle;"><?= $this->sma->formatMoney($row->subtotal - $row->total_discount); ?></td>
                                    </tr>
                                    <?php
                                    $total_purchase_value += ($row->net_unit_cost * $row->quantity);
                                    $total_purchase_value_tax += ($row->item_tax);
                                    $total_adva_tax += ($row->adv_tax);
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2 font-weight-bold">
                            <?php
                                echo $this->sma->formatMoney($total_adva_tax);
                            ?>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="row">
                        ...
                        <div class="col-sm-2 font-weight-bold">
                            <?php
                                echo $this->sma->formatMoney($total_purchase_value_tax+$total_adva_tax);
                            ?>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="row">
                        ...
                        <div class="col-sm-2 font-weight-bold">
                            <?php
                            echo $this->sma->formatMoney($total_purchase_value + $total_purchase_value_tax+$total_adva_tax);
                            ?>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2 font-weight-bold">
                            <?php
                            echo $this->sma->formatMoney(($total_purchase_value + $total_purchase_value_tax+$total_adva_tax) - $total_consumer_discount);
                            ?>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2 font-weight-bold">
                            <?= $this->sma->formatMoney(($total_purchase_value + $total_purchase_value_tax+$total_adva_tax) - $total_sales_incentive) ?>
                        </div>
                    </div>
                </div>
