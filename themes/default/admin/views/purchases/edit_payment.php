            ...
            <div id="payments">
                ...
                <div class="well well-sm well_1">
                    <div class="col-md-12">
                        ...
                        <div class="payorder_1" style="display:none;">
                            <div class="form-group"><?= lang("Payorder"); ?>
                                <input name="cheque_no" value="<?= $payment->cheque_no; ?>" type="text" id="cheque_no_1"
                                       class="form-control cheque_no"/>
                            </div>
                        </div>

                        <div class="withholdingtax_1" style="display:none;">
                            <div class="form-group"><?= lang("With Holding Tax"); ?>
                                <input name="cheque_no" value="<?= $payment->cheque_no; ?>" type="text" id="cheque_no_1"
                                       class="form-control cheque_no"/>
                            </div>
                        </div>
