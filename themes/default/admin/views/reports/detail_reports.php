...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i>Detail Report
            <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="">
                    ...
                    ?>
                    <?php echo admin_form_open("reports/detail_reports"); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php $check_national_foods = $_SESSION['user_id'] === 51 || $_SESSION['user_id'] === '51'; ?>

                                <?php if ($check_national_foods) {
                        ...
                        <?php } else { ?>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('warehouse', $whl, (isset($_POST['warehouse']) ? $_POST['warehouse'] : ""), 'class="form-control" id="warehouse" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("warehouse") . '"');
                                    ?>
                                </div>
                            </div>
                        ...
                        <table id="PrRData" class="table table-striped table-bordered table-condensed table-hover dfTable reports-table" style="margin-bottom:5px;">
                            <thead>
                                ...
                                <tr class="active">
                                    ...
                                    <?php echo ($_POST['report_type'] == 1) ? "<th>Product ID</th>" : (($_POST['report_type'] == 2) ? "<th>Product ID</th>" : (($_POST['report_type'] == 3) ? "Company Name 3" : (($_POST['report_type'] == 4) ? "Company Name 4" : (($_POST['report_type'] == 5) ? "Company Name 5" : (($_POST['report_type'] == 6) ? "" : "Own Company"))))) ?>
                                    ...
                                    <?php echo ($_POST['report_type'] == 1) ? "<th>Consumer Discount</th>" : (($_POST['report_type'] == 2) ? "<th>Consumer Discount</th>" : (($_POST['report_type'] == 3) ? "Company Name 3" : (($_POST['report_type'] == 4) ? "Company Name 4" : (($_POST['report_type'] == 5) ? "Company Name 5" : (($_POST['report_type'] == 6) ? "<th>Warehouse Id</th>" : "Own Company"))))) ?>
                            ...
                            <tfoot class="dtFilter">
                                <tr class="active">
                                    ...
                                    <?php echo ($_POST['report_type'] == 1) ? "<th>Trade Discount</th>" : (($_POST['report_type'] == 2) ? "<th>Trade Discount</th>" : (($_POST['report_type'] == 3) ? "Company Name 3" : (($_POST['report_type'] == 4) ? "Company Name 4" : (($_POST['report_type'] == 5) ? "Company Name 5" : (($_POST['report_type'] == 6) ? "<th>Warehouse Id</th>" : "Own Company"))))) ?>
