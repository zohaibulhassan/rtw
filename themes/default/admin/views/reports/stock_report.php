...
<script>
    $(document).ready(function () {
        oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getStockReport/?v=1' . $v) ?>',
            ...
            {column_number: 4, filter_default_label: "[<?=lang('payment_status');?>]", filter_type: "text", data: []},
        ], "footer");
    });
</script>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('Stock Report'); ?> <?php
            if ($this->input->post('start_date')) {
