...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i>Supplier Ledger</h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div>
                    <form action="<?= admin_url('reports/supplier_legder') ?>" method="get">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="company" id="companyID" class="form-control input-tip searching_select " data-placeholder="Select Companies" required="required" style="width:100%;" >
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start_date" value="<?php echo $start?>" class="form-control date" id="start_date" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="end_date">End Date</label>
                                    <input type="text" name="end_date" value="<?php echo $end?>" class="form-control date" id="end_date" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
    ...
    $(document).ready(function(){
        ...
        $('.remarkschange').dblclick(function(){
            ...
            Swal.fire({
                ...
                preConfirm: (remarks) => {
                    return fetch(`<?= base_url('admin/reports/remarks?payid=') ?>${payid}&purchase_id=${purchase_id}&remarks=${remarks}&[${csrfName}]=${csrfHash}`)
                    .then(response => {
