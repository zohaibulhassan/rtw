...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i>Purchase Items Wise Report</h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12" id="headerdiv">
                ...
                <div>
                    <form action="<?= admin_url('reports/purchasereport') ?>" method="get">
                        <div class="row">
                            <div class="col-md-4">
    ...
    $(document).ready(function(){
        ...
        function loadTable(req = ""){
            ...
            $('.tabledb').DataTable({
                ...
                autoWidth: true,
                responsive: true,
                ajax: "<?= admin_url('reports/purchasereport_ajax?'.$req) ?>",
                buttons: [
                    {
                        extend: 'copy',
                    },
