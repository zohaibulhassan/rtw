...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i>PO Items Wise Report</h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12" id="headerdiv">
                ...
                <div>
                    <form action="<?= admin_url('reports/po_items_wise') ?>" method="get">
                        <div class="row">
                            <div class="col-md-4">
...
<script>
    $(document).ready(function(){
        ...
        function loadTable(req = ""){
            ...
            $('.tabledb').DataTable({
                dom: 'Bfrtip',
                ajax: "<?= admin_url('reports/po_items_wise_ajax?'.$req) ?>",
                buttons: [
                    {
                        extend: 'copy',
                    },
