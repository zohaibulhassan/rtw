...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i>Cross Expected Sold-Out Days</h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12" id="headerdiv">
                ...
                <div>
                    <form action="<?= admin_url('reports/expected_soldout') ?>" method="get">
                        <div class="row">
                            <div class="col-md-3">
                ...
                <table class="tabledb">
                    ...
                    <tbody>
                        ...
                        foreach($rows as $row){
                            ...
                            $edays = abs(strtotime(date('Y-m-d')) - strtotime($fexpiry));
                            $edays = $edays/(24*60*60);

                            $fpurchase = date('Y-m-d', strtotime($row->date));
                            $pdays = abs(strtotime($fpurchase) - strtotime(date('Y-m-d')));
                            $pdays = $pdays/(24*60*60);
