<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
        ...
        <footer>
            ...
            <p style="text-align:center;">&copy; <?= date('Y') ?> Powered by Rholab Interactive</p>
        </footer>
    </div>
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    ...
    <?= ($m == 'purchaseorder' && ($v == 'add' || $v == 'edit' || $v == 'purchase_by_csv')) ? '<script type="text/javascript" src="' . $assets . 'js/purchaseorder.js"></script>' : ''; ?>
    <?= ($m == 'salesorders' && ($v == 'add' || $v == 'edit' || $v == 'purchase_by_csv')) ? '<script type="text/javascript" src="' . $assets . 'js/salesorders.js"></script>' : ''; ?>
    ...
    <script>
        $(document).ready(function(){
            ...
            setInterval(function () {
                ...
                showDateTime = showDateTimey+"-"+showDateTimem+"-"+showDateTimed+" "+showDateTimeH+":"+showDateTimei+":"+showDateTimes;
