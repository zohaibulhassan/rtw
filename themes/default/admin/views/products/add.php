...
<?php
$company_code_comapny_name = array('' => 'Select Company Name', 'daraz' => 'Daraz', 'qne' => 'Qne', 'mycart' => 'Mycart', 'tazamart' => 'Tazamart', 'yayvo' => 'Yayvo');
if (!empty($variants)) {
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        <?= lang("Product Group", "gid") ?>
                        <select name="gid" id="gid" class="form-control searching_select">
                    ...
                    <div class="form-group all">
                        <?= lang("Parent Product", "pid") ?>
                        <?= form_input('pid', (isset($_POST['pid']) ? $_POST['pid'] : ($product ? $product->parent_product_id : '')), 'class="form-control" id="pid" required="required"'); ?>
                    </div>
                    <div class="form-group all">
                    ...
                    <div class="form-group all">
                        <?= lang("company_code", "company_code") ?>
                        <?= form_input('company_code', (isset($_POST['company_code']) ? $_POST['company_code'] : ($product ? $product->company_code : '')), 'class="form-control" id="company_code" ') ?>
                    </div>
                    ...
                    <div class="form-group all">
                        ...
                        echo form_dropdown('brand', $br, (isset($_POST['brand']) ? $_POST['brand'] : ($product ? $product->brand : '')), 'class="form-control select" id="brand" required="required"  placeholder="' . lang("select") . " " . lang("brand") . '" style="width:100%"')
                        ?>
                    </div>
                    <div class="form-group all">
                    ...
                    <div class="form-group">
                        <?= lang('fed_tax', 'fed_tax'); ?>
                        <?= form_input('fed_tax', set_value('hsn_code', ($product ? $product->fed_tax : '')), 'class="form-control" id="fed_tax"'); ?>
                    </div>
                    <div class="form-group">
                        <label for="adv_tax_reg">Register Advance Tax (Sales)</label>
                        <?= form_input('adv_tax_reg', set_value('adv_tax_reg', ($product ? $product->adv_tax_reg : '')), 'class="form-control" id="adv_tax_reg"'); ?>
                    </div>
                    <div class="form-group">
                        <label for="adv_tax_nonreg">Non Register Advance Tax (Sales)</label>
                        <?= form_input('adv_tax_nonreg', set_value('adv_tax_nonreg', ($product ? $product->adv_tax_nonreg : '')), 'class="form-control" id="adv_tax_nonreg"'); ?>
                    </div>
                    <div class="form-group">
                        <label for="adv_tax_for_purchase">Advance Tax (Purchase)</label>
                        <?= form_input('adv_tax_for_purchase', set_value('adv_tax_for_purchase', ($product ? $product->adv_tax_for_purchase : '')), 'class="form-control" id="adv_tax_for_purchase"'); ?>
                    </div>
                    ...
                    <div class="form-group standard">
                        <label>Stock Hold Quantity</label>
                        <input type="number" class="form-control tip" value="0" min="0" id="hold_quantity" name="hold_qty" required="required">
                    </div>
                    <div class="form-group standard">
                        <label>Expected Sold-Out Days</label>
                        <input type="number" class="form-control tip" value="" min="1" id="es_duration" name="es_duration" required="required">
                    </div>
                    <div class="form-group standard">
                        <label>Short Expiry Days</label>
                        <input type="number" class="form-control tip" value="" min="1" id="shotexpiry_days" name="shotexpiry_days" required="required">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="product_status" class="padding05"><?= lang('Product Active') ?></label><br><br>
                        <input type="radio" id="product_status" name="product_status" value="1" checked> <strong>Activate</strong><br>
                        <input type="radio" id="product_status" name="product_status" value="0" class="checkbox"><strong>Deactivate</strong>
                    </div>
                ...
                <div class="col-md-6 col-md-offset-1">
                    ...
                    <div class="form-group all">
                        <?= lang("product_dropship", "dropship") ?>
                        <?= form_input('dropship', (isset($_POST['dropship']) ? $_POST['dropship'] : ($product ? $this->sma->formatDecimal($product->dropship) : '')), 'class="form-control tip" id="dropship" required="required"') ?>
                    </div>
                    <div class="form-group all">
                        <?= lang("product_crossdock", "Asanbuy") ?>
                        <?= form_input('crossdock', (isset($_POST['crossdock']) ? $_POST['crossdock'] : ($product ? $this->sma->formatDecimal($product->crossdock) : '')), 'class="form-control tip" id="crossdock" required="required"') ?>
                    </div>
                    <div class="form-group all">
                        <?= lang("product_mrp", "mrp") ?>
                        <?= form_input('mrp', (isset($_POST['mrp']) ? $_POST['mrp'] : ($product ? $this->sma->formatDecimal($product->mrp) : '')), 'class="form-control tip" id="mrp" required="required"') ?>
                    </div>

                    <div class="form-group all">
                        <?= lang("discount_mrp", "discount_mrp") ?>
                        <?= form_input('discount_mrp', (isset($_POST['discount_mrp']) ? $_POST['discount_mrp'] : ($product ? "$this->sma->formatDecimal($product->discount_mrp)" : "0")), 'class="form-control tip" id="discount_mrp"') ?>
                    </div>

                    <div class="form-group combo">
                        <?= lang("total_tax", "total_tax") ?>
                        <?= form_input('total_tax', (isset($_POST['total_tax']) ? $_POST['total_tax'] : ($product ? $this->sma->formatDecimal($product->total_tax) : '')), 'class="form-control tip" id="total_tax"') ?>
                    </div>


                    <div class="form-group all">
                        <?= lang("discount_one", "discount_one") ?>
                        <?= form_input('discount_one', (isset($_POST['discount_one']) ? $_POST['discount_one'] : ($product ? $this->sma->formatDecimal($product->discount_one) : '')), 'class="form-control tip" id="discount_one"') ?>
                    </div>

                    <div class="form-group all">
                        <?= lang("discount_two", "discount_two") ?>
                        <?= form_input('discount_two', (isset($_POST['discount_two']) ? $_POST['discount_two'] : ($product ? $this->sma->formatDecimal($product->discount_two) : '')), 'class="form-control tip" id="discount_two"') ?>
                    </div>

                    <div class="form-group all">
                        <?= lang("discount_three", "discount_three") ?>
                        <?= form_input('discount_three', (isset($_POST['discount_three']) ? $_POST['discount_three'] : ($product ? $this->sma->formatDecimal($product->discount_three) : '')), 'class="form-control tip" id="discount_three"') ?>
                    </div>
                                ...
                                <table id="prTable" class="table items table-striped table-bordered table-condensed table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-3 col-sm-3 col-xs-3"><?= lang("tax_calculate"); ?></th>
                    ...
                    <div class="form-group all">
                        <div class="form-group">
                            <?= lang("CompanyCode", "CompanyCode") ?>
                            <button type="button" class="btn btn-primary btn-xs" id="addCompanyCode"><i class="fa fa-plus"></i>
                            </button>
                        </div>
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_asanbuy', "Asanbuy", 'readonly = "true" class="form-control tip" id="productcompanyname_asanbuy" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_asanbuy', (isset($_POST['productcompanyprice_asanbuy']) ? $_POST['productcompanyprice_asanbuy'] : "0"), 'class="form-control tip" id="CompanyCode_sku" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_daraz', "OlpermartKHI", 'readonly = "true" class="form-control tip" id="productcompanyname_daraz" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_daraz', (isset($company_prices_and_names->OlpermartKHI) ? $company_prices_and_names->OlpermartKHI : "0"), 'class="form-control tip" id="CompanyCode_sku" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_olper_lhr', "OlpermartLHR", 'readonly = "true" class="form-control tip" id="productcompanyname_olper_lhr" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_olper_lhr', (isset($company_prices_and_names->OlpermartLHR) ? $company_prices_and_names->OlpermartLHR : "0"), 'class="form-control tip" id="CompanyCode_sku" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_distro', "DistributionAsanbuy", 'readonly = "true" class="form-control tip" id="productcompanyname_distro" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_distro', (isset($_POST['productcompanyprice_distro']) ? $_POST['productcompanyprice_distro'] : "0"), 'class="form-control tip" id="CompanyCode_sku" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_hummart', "Hummart", 'readonly = "true" class="form-control tip" id="productcompanyname_hummart" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_hummart', (isset($_POST['productcompanyprice_hummart']) ? $_POST['productcompanyprice_hummart'] : "0"), 'class="form-control tip" id="productcompanyprice_hummart" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_mycart', "Mycart", 'readonly = "true" class="form-control tip" id="productcompanyname_mycart" placeholder="' . lang('productcompanyname_mycart') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_mycart', (isset($_POST['productcompanyprice_mycart']) ? $_POST['productcompanyprice_mycart'] : "0"), 'class="form-control tip" id="productcompanyprice_mycart" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_mygerries', "Mygerries", 'readonly = "true" class="form-control tip" id="productcompanyname_mygerries" placeholder="' . lang('productcompanyname_mygerries') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_mygerries', (isset($_POST['productcompanyprice_mygerries']) ? $_POST['productcompanyprice_mygerries'] : "0"), 'class="form-control tip" id="productcompanyprice_mygerries" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_qne', "Qne", 'readonly = "true" class="form-control tip" id="productcompanyname_qne" placeholder="' . lang('productcompanyname_qne') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_qne', (isset($_POST['productcompanyprice_qne']) ? $_POST['productcompanyprice_qne'] : "0"), 'class="form-control tip" id="productcompanyprice_qne" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_telemart', "Telemart", 'readonly = "true" class="form-control tip" id="productcompanyname_telemart" placeholder="' . lang('productcompanyname_telemart') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_telemart', (isset($_POST['productcompanyprice_telemart']) ? $_POST['productcompanyprice_telemart'] : "0"), 'class="form-control tip" id="productcompanyprice_telemart" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_areywow', "Areywow", 'readonly = "true" class="form-control tip" id="productcompanyname_areywow" placeholder="' . lang('productcompanyname_areywow') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_areywow', (isset($_POST['productcompanyprice_areywow']) ? $_POST['productcompanyprice_areywow'] : "0"), 'class="form-control tip" id="productcompanyprice_areywow" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_ishopping', "iShopping", 'readonly = "true" class="form-control tip" id="productcompanyname_ishopping" placeholder="' . lang('productcompanyname_ishopping') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_ishopping', (isset($_POST['productcompanyprice_ishopping']) ? $_POST['productcompanyprice_ishopping'] : "0"), 'class="form-control tip" id="productcompanyprice_ishopping" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="CompanyCode-con">
                            <div class="col-xs-6">
                                <div class="form-group all">
                                    <?= form_input('productcompanyname_yayvo', "Yayvo", 'readonly = "true" class="form-control tip" id="productcompanyname_yayvo" placeholder="' . lang('productcompanyname_yayvo') . '"'); ?>
                                    <?php
                                    // echo form_dropdown('productcompanyname[]', $company_code_comapny_name, (isset($_POST['productcompanyname']) ? $_POST['productcompanyname'] : ($product ? $product->productcompanyname : 'code128')), 'class="form-control select" id="productcompanyname" style="width:100%;"');
                                    ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <?= form_input('productcompanyprice_yayvo', (isset($_POST['productcompanyprice_yayvo']) ? $_POST['productcompanyprice_tazamart'] : "0"), 'class="form-control tip" id="productcompanyprice_yayvo" placeholder="' . lang('CompanyCode_sku') . '"'); ?>
                                </div>
                            </div>
                        </div>

                        <div id="ex-CompanyCode"></div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <input name="cf" type="checkbox" class="checkbox" id="extras" value="" checked="checked" /><label for="extras" class="padding05"><?= lang('Daraz API') ?></label>
                        </div>
                        <div class="row" id="extras-con">
                            ...
                            <div class="col-md-4">
                                <div class="form-group all">
                                    ...
                                    <?= form_input('username', (isset($_POST['username']) ? $_POST['username'] : ($product ? $product->username : '')), 'class="form-control tip" id="username"') ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group all">
                                    <?= lang('Api key', 'apikey') ?>
                                    <?= form_input('apikey', (isset($_POST['apikey']) ? $_POST['apikey'] : ($product ? $product->apikey : '')), 'class="form-control tip" id="cf2"') ?>
                                </div>
                            </div>

                            <div class="col-md-4">
                                <div class="form-group all">
                                    <?= lang('Product SKU Code', 'cf3') ?>
                                    <?= form_input('sku_code', (isset($_POST['sku_code']) ? $_POST['sku_code'] : ($product ? $product->sku_code : '')), 'class="form-control tip" id="sku_code"') ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group all">
                                    <?= lang('Pack size', 'cf3') ?>
                                    <?= form_input('pack_size', (isset($_POST['pack_size']) ? $_POST['pack_size'] : ($product ? $product->pack_size : '1')), 'class="form-control tip" id="pack_size"') ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group all">
                                    <?= lang('Carton Size', 'cf3') ?>
                                    <?= form_input('carton_size', (isset($_POST['carton_size']) ? $_POST['carton_size'] : ($product ? $product->carton_size : '1')), 'class="form-control tip" id="carton_size"') ?>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <label for="extras" class="padding05"><?= lang('product_dimension') ?></label>
                    </div>
    ...
    $(document).ready(function() {
        ...
        function add_product_item(item) {
            ...
            $.each(items, function() {
                ...
                tr_html += '<td><input class="form-control text-center rrate" name="combo_item_rate[]" type="text" value="' + formatDecimal(this.rate) + '" data-id="' + row_no + '" data-item="' + this.id + '" id="rate_' + row_no + '" onClick="this.select();"></td>';


                tr_html += '<td class="hidden"><input class="form-control text-center rcost hidden" name="combo_item_cost[]" type="text" value="' + formatDecimal(this.cost) + '" data-id="' + row_no + '" data-item="' + this.id + '" id="cost_' + row_no + '" onClick="this.select();"></td>';

                tr_html += '<td class="hidden"><input class="form-control text-center rcrossdock hidden" name="combo_item_crossdock[]" type="text" value="' + formatDecimal(this.crossdock) + '" data-id="' + row_no + '" data-item="' + this.id + '" id="crossdock_' + row_no + '" onClick="this.select();"></td>';

                tr_html += '<td class="hidden"><input class="form-control text-center rdropship hidden" name="combo_item_dropship[]" type="text" value="' + formatDecimal(this.dropship) + '" data-id="' + row_no + '" data-item="' + this.id + '" id="dropship_' + row_no + '" onClick="this.select();"></td>';

                tr_html += '<td class="hidden"><input class="form-control text-center rmrp hidden" name="combo_item_mrp[]" type="text" value="' + formatDecimal(this.mrp) + '" data-id="' + row_no + '" data-item="' + this.id + '" id="mrp_' + row_no + '" onClick="this.select();"></td>';
                ...
                tt += formatDecimal(parseFloat(this.rate) * parseFloat(this.qty));

                cc += formatDecimal(parseFloat(this.cost) * parseFloat(this.qty));
                dd += formatDecimal(parseFloat(this.dropship) * parseFloat(this.qty));
                cd += formatDecimal(parseFloat(this.crossdock) * parseFloat(this.qty));
                mm += formatDecimal(parseFloat(this.mrp) * parseFloat(this.qty));
        ...
        function calculate_cost() {
            ...
            var pp = 0;
            $.each(rows, function() {
                pp += formatDecimal(parseFloat($(this).find('.rcost').val()) * parseFloat($(this).find('.rquantity').val()));
            });
            $('#cost').val(pp);
            return true;
        }

        function calculate_dropship() {
            var rows = $('#prTable').children('tbody').children('tr');
            var pp = 0;
            $.each(rows, function() {
                pp += formatDecimal(parseFloat($(this).find('.rdropship').val()) * parseFloat($(this).find('.rquantity').val()));
            });
            $('#dropship').val(pp);
            return true;
        }

        function calculate_crossdock() {
            var rows = $('#prTable').children('tbody').children('tr');
            var pp = 0;
            $.each(rows, function() {
                pp += formatDecimal(parseFloat($(this).find('.rcrossdock').val()) * parseFloat($(this).find('.rquantity').val()));
            });
            $('#crossdock').val(pp);
            return true;
        }

        function calculate_mrp() {
            var rows = $('#prTable').children('tbody').children('tr');
            var mm = 0;
            $.each(rows, function() {
                mm += formatDecimal(parseFloat($(this).find('.rmrp').val()) * parseFloat($(this).find('.rquantity').val()));
            });
            $('#mrp').val(mm);
            return true;
        }
        ...
        function calculate_tax() {
            ...
            var pp = 0;
            $.each(rows, function() {
                pp += formatDecimal(parseFloat($(this).find('.rrate').val()) * parseFloat($(this).find('.rquantity').val()));
            });
            $('#total_tax').val(pp);
            return true;
        }
        ...
        // var cc = 2;
        // $('#addCompanyCode').click(function () {
        //     $('#CompanyCode_1').select2('destroy');
        //     var html = '<div style="clear:both;height:5px;"></div><div class="row"><div class="col-xs-6"><div class="form-group"> <select name="productcompanyname[]"  class="form-control" > <option value="" disabled selected class="select2-drop-mask">Select Company Name</option> <option value="daraz">Daraz</option> <option value="qne">Qne</option> <option value="mycart">Mycart</option> <option value="tazamart">Tazamart</option>  <option value="yayvo">Yayvo</option>  </select> </div></div><div class="col-xs-6"><div class="form-group"><input type="text" name="productcompanyprice[]" class="form-control tip" id="productcompanyprice" placeholder="<?= lang('CompanyCode_sku') ?>" /></div></div></div>';
        //     $('#ex-CompanyCode').append(html);
        //     var compcode = $('#CompanyCode_' + cc);
