...
<?php if ($Owner || $Admin) { ?>
    <ul id="myTab" class="nav nav-tabs">
        ...
        <?php } else { ?>
            <?php if ($GP['products-index'] || $GP['reports-sales'] || $GP['quotes-index'] || $GP['reports-purchases'] || $GP['transfers-index'] || $GP['reports-products']) { ?>
    <ul id="myTab" class="nav nav-tabs">
        <?php if ($GP['products-index']){?>
        <li class=""><a href="#details" class="tab-grey"><?= lang('product_details') ?></a></li>
        <?php } ?>
        <?php if ($GP['reports-sales'] || $GP['reports-purchases']){?>
        <li class=""><a href="#chart" class="tab-grey"><?= lang('chart') ?></a></li>
        <?php } ?>
        ...
        <?php } ?>
        <?php }?>
        <?php if ($Owner || $Admin || $GP['products-index'] || $GP['reports-sales'] || $GP['quotes-index'] || $GP['reports-purchases'] || $GP['transfers-index'] || $GP['reports-products']) { ?>
                        ...
                        <div class="row">
                                ...
                                <div class="table-responsive">
                                   <table class="table table-borderless table-striped dfTable table-right-left">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($product->weight ? $product->weight : ''); ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang("brand"); ?></td>
                                        ...
                                        <tr>
                                            <td><?= lang("default_sale_unit"); ?></td>
                                            <td><?= $sale_unit ? $sale_unit->name.' ('.$sale_unit->code.')' : ''; ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang("default_purchase_unit"); ?></td>
                                        ...
                                        <?php if ($Owner || $Admin) {
                                            ...
                                            echo '<tr><td>' . lang("consiment") . '</td><td>' . $this->sma->formatMoney($product->price) . '</td></tr>';
                                        ...
                                        ?>
                                          <?php if ($product->dropship) { ?>
                                         <tr>
                                                <td><?= lang("dropship"); ?></td>
                                                <td><?php echo $product->dropship; ?></td>
                                         </tr>
                                         <?php } ?>
                                         <?php if ($product->crossdock) { ?>
                                        <tr>
                                                <td><?= lang("Crossdock (Asanbuy)"); ?></td>
                                                <td><?php echo $product->crossdock; ?></td>
                                         </tr>
                                         <?php } ?>
                                          <?php if ($product->mrp) { ?>
                                        <tr>
                                         ...
                                         <?php } ?>
                                          <?php if ($product->discount_mrp) { ?>
                                        <tr>
                                                <td><?= lang("discounted_mrp"); ?></td>
                                                <td><?php echo $product->discount_mrp; ?></td>
                                         </tr>
                                         <?php } ?>
                                          <?php if ($product->discount_one) { ?>
                                        <tr>
                                                <td><?= lang("sales_incentive"); ?></td>
                                                <td><?php echo $product->discount_one; ?></td>
                                         </tr>
                                         <?php } ?>
                                         <?php if ($product->discount_two) { ?>
                                        <tr>
                                                <td><?= lang("trade_discount"); ?></td>
                                                <td><?php echo $product->discount_two; ?></td>
                                         </tr>
                                         <?php } ?>
                                         <?php if ($product->discount_three) { ?>
                                        <tr>
                                                <td><?= lang("consumer_discount"); ?></td>
                                                <td><?php echo $product->discount_three; ?></td>
                                         </tr>
                                         <?php } ?>
                                        
                                            <tr>
                                                <td><?= lang("fed_tax"); ?></td>
                                                <td><?php echo ($product->fed_tax) ? ($product->fed_tax) : ($product->fed_tax); ?></td>
                                            </tr>
                                            <tr>
                                                <td><label for="adv_tax_reg">Register Advance Tax (Sales)</label></td>
                                                <td><?php echo $product->adv_tax_reg; ?></td>
                                            </tr>
                                            <tr>
                                                <td><label for="adv_tax_nonreg">Non Register Advance Tax (Sales)</label></td>
                                                <td><?php echo $product->adv_tax_nonreg; ?></td>
                                            </tr>
                                            <tr>
                                                <td><label for="adv_tax_for_purchase">Advance Tax (Purchase)</label></td>
                                                <td><?php echo $product->adv_tax_for_purchase; ?></td>
                                            </tr>
                                        ...
                                        <?php } ?>
                                            ...
                                            <tr>
                                                <td><?= lang("Stock Hold Quantity"); ?></td>
                                                <td><?php echo $this->sma->formatQuantity($product->hold_stock); ?></td>
                                            </tr>

                                            <tr>
                                                <td><?= lang("Expected Sold-Out Days"); ?></td>
                                                <td><?php echo ($product->es_durration) ? ($product->es_durration) : 0; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?= lang("Short Expiry Days"); ?></td>
                                                <td><?php echo ($product->short_expiry_duration) ? ($product->short_expiry_duration) : 0; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?= lang("Pack size"); ?></td>
                                                <td><?php echo ($product ? $product->pack_size : ''); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?= lang("Carton Size"); ?></td>
                                                <td><?php echo ($product ? $product->carton_size : ''); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?= lang("pcf1"); ?></td>
                                                <td><?php echo ($product ? $product->cf1 : ''); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?= lang("pcf2"); ?></td>
                                                <td><?php echo ($product ? $product->cf2 : ''); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?= lang("pcf3"); ?></td>
                                                <td><?php echo ($product ? $product->cf3 : ''); ?></td>
                                            </tr>
                                            <tr>
                                                <td>Status</td>
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <h3 class="bold"><?= lang('supplier_details') ?></h3>
                                            <div class="table-responsive">
                                                <table
                                                    class="table table-bordered table-striped table-condensed dfTable two-columns">
                                                    <thead>
                                                    ...
                                                    <tr>
                                                        <td>Supplier 1</td>
                                                        <td><?php echo (!empty($supplier1->company)) ? $supplier1->company : " ";?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Supplier 2</td>
                                                        <td><?php echo (!empty($supplier2->company)) ? $supplier2->company : " ";?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Supplier 3</td>
                                                        <td><?php echo (!empty($supplier3->company)) ? $supplier3->company : " ";?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Supplier 4</td>
                                                        <td><?php echo (!empty($supplier4->company)) ? $supplier4->company : " ";?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Supplier 5</td>
                                                        <td><?php echo (!empty($supplier5->company)) ? $supplier5->company : " ";?></td>
                                                    </tr>
                            ...
                            <div class="col-sm-12">
                                        ...
                                        <h3 class="bold"><?= lang('store_details') ?></h3>
                                            <div class="table-responsive">
                                                <table
                                                    class="table table-bordered table-striped table-condensed dfTable five-columns">
                                                    <thead>
                                                    <tr>
                                                        <th><?= lang('store_name') ?></th>
                                                        <th><?= lang('store_product_id') ?></th>
                                                        <th><?= lang('store_product_name') ?></th>
                                                        <th><?= lang('store_product_type') ?></th>
                                                        <th><?= lang('store_price_type') ?></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?php echo $store_product['store_name'];?></td>
                                                        <td><?php echo $store_product['spid'];?></td>
                                                        <td><?php echo $store_product['spname'];?></td>
                                                        <td><?php echo $store_product['product_type'];?></td>
                                                        <td><?php echo $store_product['price_type'];?></td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                    </tbody>
                                                </table>
            ...
            $(document).ready(function () {
                oTable = $('#SlRData').dataTable({
                    ...
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        var gtotal = 0, paid = 0, balance = 0, total_purchase=0;
                        for (var i = 0; i < aaData.length; i++) {
                            total_purchase += parseFloat((aaData[aiDisplay[i]][4]).split('__').pop());
                            gtotal += parseFloat(aaData[aiDisplay[i]][5]);
                            paid += parseFloat(aaData[aiDisplay[i]][6]);
                            balance += parseFloat(aaData[aiDisplay[i]][7]);
                        }
                        var nCells = nRow.getElementsByTagName('th');
                        nCells[4].innerHTML = currencyFormat(parseFloat(total_purchase));
    ...
    <div id="purchases" class="tab-pane fade">
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                "bSearchable": false,
                "mRender": pqFormat
                }, null , {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}],
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        var gtotal = 0, paid = 0, balance = 0 , total_purchase = 0;
                        for (var i = 0; i < aaData.length; i++) {
                            total_purchase += parseFloat((aaData[aiDisplay[i]][3]).split('__').pop());
                            gtotal += parseFloat(aaData[aiDisplay[i]][5]);
                            paid += parseFloat(aaData[aiDisplay[i]][6]);
                            balance += parseFloat(aaData[aiDisplay[i]][7]);
                        }
                        var nCells = nRow.getElementsByTagName('th');
                        nCells[3].innerHTML = currencyFormat(parseFloat(total_purchase));
                        nCells[5].innerHTML = currencyFormat(parseFloat(gtotal));
                        nCells[6].innerHTML = currencyFormat(parseFloat(paid));
                        nCells[7].innerHTML = currencyFormat(parseFloat(balance));
                    }
