...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i>Check Rhocom's Products Intergration By Size (<?= $store->name ?>)</h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12" id="headerdiv">
                <div>
                    <form action="<?= admin_url('stores/report4') ?>" method="get">
                        <div class="row">
                            <div class="col-sm-3">
