    ...
    <div class="page-back">
        <div class="text-center">
            <?php if ($Settings->logo2) {
                echo '<img src="' . base_url('assets/images/300_X_80_Rho_Com_360_.png') . '" alt="' . $Settings->site_name . '" style="" />';
            } ?>
        </div>
       ...
       <div style="text-align: center;color: #fff;padding-top: 21px;">Powered by <a href="http://rholab.net" target="_blank" rel="noopener noreferrer" style="color: #fff;">RHOLAB</a></div>
        <?php
        if ($Settings->allow_reg) {
            ?>
            <div id="register">
