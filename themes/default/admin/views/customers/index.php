    ...
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, null, null, null, null, null, null, {"mRender": currencyFormat}, null, {"bSortable": false}]
        }).dtFilter([
            {column_number: 1, filter_default_label: "[<?=lang('customer_type');?>]", filter_type: "text", data: []},
            ...
            {column_number: 10, filter_default_label: "[<?=lang('NTN Number');?>]", filter_type: "text", data: []},
