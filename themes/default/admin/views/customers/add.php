            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <label class="control-label" for="sales_type"><?php echo $this->lang->line("Sales Type"); ?></label>
                        ...
                        echo form_dropdown('sales_type', $sales_type, $Settings->sales_type, 'class="form-control select" id="sales_type" style="width:100%;" required ');
                        ?>
                    </div>
                    ...
                    <div class="form-group">
                        <?= lang("CNIC *", "CNIC"); ?>
                        <?php echo form_input('cnic', '', 'class="form-control tip" id="cnic" data-bv-notempty="true"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("vat_no", "vat_no"); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('ntn_number', '', 'class="form-control" id="ntn_number"'); ?>
                    </div>
