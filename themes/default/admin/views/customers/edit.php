        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <label class="control-label" for="sales_type"><?php echo $this->lang->line("Sales Type"); ?></label>
                        <?php
                        $sales_type = array(
                            '' => 'Select Sale Type', 
                            'cost' => 'Cost Price', 
                        ...
                        echo form_dropdown('sales_type', $sales_type, $customer->sales_type, 'class="form-control select" id="sales_type" style="width:100%;" required ');
                        ?>
                    </div>
                    ...
                    <div class="form-group">
                        <?= lang("CNIC *", "CNIC"); ?>
                        <?php echo form_input('cnic', $customer->cnic, 'class="form-control tip" id="cnic" data-bv-notempty="true"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("vat_no", "vat_no"); ?>
                    ...
                    <div class="form-group">
                        <?= lang("STRN Number", "gst_no"); ?>
                        <?php echo form_input('gst_no', $customer->gst_no, 'class="form-control" id="gst_no"'); ?>
                    </div>


                    <div class="form-group">
                        <?= lang("NTN / SNTN Number", "ntn_number"); ?>
                        <?php echo form_input('ntn_number', $customer->cf1, 'class="form-control" id="ntn_number"'); ?>
                    </div>
