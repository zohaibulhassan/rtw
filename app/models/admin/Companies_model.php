...
class Companies_model extends CI_Model
{
    ...
    {
        // $this->db->select("id, (CASE WHEN company = '-' THEN name ELSE CONCAT(company, ' (', name, ')') END) as text, (CASE WHEN company = '-' THEN name ELSE CONCAT(company, ' (', name, ')') END) as value, phone, sales_type", FALSE);
        $this->db->select("id, (CASE WHEN company = '-' THEN name ELSE CONCAT(name) END) as text, (CASE WHEN company = '-' THEN name ELSE CONCAT(name) END) as value, phone, sales_type", FALSE);
