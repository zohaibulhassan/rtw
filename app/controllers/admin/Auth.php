...
class Auth extends MY_Controller
{
    ...
    public function get_users(){
        ...
        foreach($rows as $row){
            ...
            // $button .= '<a href="'.base_url("admin/pop_journey/index/".$row->id).'" class="md-btn md-btn-success md-btn-wave-light waves-effect waves-button waves-light md-btn-mini" data-mdb-toggle="tooltip" title="Hi! I am tooltip">Journey Plan</a>';
            // $button .= '<a href="'.base_url("admin/booker_targets/index/".$row->id).'" class="md-btn md-btn-success md-btn-wave-light waves-effect waves-button waves-light md-btn-mini" data-mdb-toggle="tooltip" title="Hi! I am tooltip">Target Settings</a>';
            // $button .= '<button class="md-btn md-btn-danger md-btn-wave-light waves-effect waves-button waves-light md-btn-mini" data-id="'.$row->id.'" >User Tracking</button>';
    ...
    public function tracking($id){
        ...
        $this->data['error'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error');
        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => '#', 'page' => lang('Tracking')));
        $meta = array('page_title' => lang('User Tracking'), 'bc' => $bc);
    ...
    public function create_user_submit(){
        ...
        if($returnmessage == ""){
            $sendvalue['message'] = 'User create successfully!';
        }
        else{
